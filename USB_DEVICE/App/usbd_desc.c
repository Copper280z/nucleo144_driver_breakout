...
#define USBD_MANUFACTURER_STRING     "Copper280z"
#define USBD_PID_HS     22336
#define USBD_PRODUCT_STRING_HS     "WOOO SERVOS"
#define USBD_CONFIGURATION_STRING_HS     "CDC Servos"
#define USBD_INTERFACE_STRING_HS     "CDC Servo Interface"
